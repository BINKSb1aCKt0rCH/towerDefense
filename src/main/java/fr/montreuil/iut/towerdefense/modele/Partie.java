...
//-----------------------------------------------------------------------------------------------------------------------------------
    ...
    public void ajouterTourDansListe(double x, double y, MapModele mapModele, int choixTour){
        if (choixTour == 1)
            listeTours.add(new TourGeo(x, y, mapModele,this));
        else if (choixTour == 2)
            listeTours.add(new TourCryo(x, y, mapModele,this));
        else if (choixTour == 3)
            listeTours.add(new TourPyro(x, y, mapModele,this));
        else
            listeTours.add(new TourElectro(x, y, mapModele,this));
    }
